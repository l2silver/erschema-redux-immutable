...
export function reorder(mapOfRelationshipTypes: Object, mapOfRelationshipTypesById?: Object) {
...
export function link(mapOfRelationshipTypes: Object, mapOfRelationshipTypesById?: Object) {
  return function (state: Map<string, any>, {payload, error}: Object) {
    if (error) {
      return state
    }
...
export function create(mapOfRelationshipTypes: Object, mapOfRelationshipTypesById?: Object) {
  return function (state: Map<string, any>, {payload, error}: Object) {
    if (error) {
      return state
    }
...
export function concat(mapOfRelationshipTypes: Object, mapOfRelationshipTypesById?: Object) {
  return function (state: Map<string, any>, {payload, error}: Object) {
    if (error) {
      return state
    }
...
export function unlink(mapOfRelationshipTypes: Object, mapOfRelationshipTypesById?: Object) {
  return function (state: Map<string, any>, {payload, error}: Object) {
    if (error) {
      return state
    }
...
export function index(mapOfRelationshipTypes: Object, mapOfRelationshipTypesById?: Object) {
  return function (state: Map<string, any>, {payload, error}: Object) {
    if (error) {
      return state
    }
...
export function remove(mapOfRelationshipTypes: Object, relationshipNames: string[][], mapOfRelationshipTypesById?: Object) {
  return function (state: Map<string, any>, {payload, error}: Object) {
    if (error) {
      return state
    }
